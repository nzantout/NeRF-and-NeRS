...
def render(
    ...
    imageio.mimsave(f'images/{cfg.save_filename}', [np.uint8(im * 255) for im in all_images], loop=0)
...
def train_points(
    ...
    for epoch in range(0, cfg.training.num_epochs):
        ...
        for idx in t_range:
            ...
            loss = torch.mean(torch.square(distances)) # TODO (Q6): Point cloud SDF loss on distances
